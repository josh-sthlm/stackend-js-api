...
import * as searchActions from '../search/searchActions.js';
import {
	CHANGE_QNA_PAGE,
	CHANGE_FILTER,
...
type ChangeFilter = {
	filter: {
		(filterName: FilterTypes): IssueTypes, //filterName is the filter group (currently only issue), and the value is selected filter
