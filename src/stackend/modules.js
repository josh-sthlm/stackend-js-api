...
export type ModuleTypes = $Values<typeof ModuleType>;
...
export type ModuleInfo = {
	...
	/** Component name */
	xcapModuleType: ?string,

	/** Component context */
	defaultContext: ?string
};

export const MODULE_INFO: { [ModuleTypes]: ModuleInfo } = {
	[ModuleType.FEED]: {
		name: 'Feed',
 ...
 */
export const AUTOMATIC_MODULE_TYPES: Array<ModuleTypes> = [
 ...
 * @returns ModuleInfo
 */
export function getModuleInfo(moduleType: ModuleTypes): ?ModuleInfo {
 ...
 * @returns {string}
 */
export function getXcapModuleType(moduleType: ModuleTypes): string {
	let i = MODULE_INFO[moduleType];
 ...
 * @param moduleType
 */
export function getDefaultComponentContext(moduleType: ModuleTypes): string {
	let i = MODULE_INFO[moduleType];
 ...
 * @returns {string}
 */
export function getModuleLabel(moduleType: ModuleTypes): string {
