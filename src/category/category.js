//@flow
import { getJson, post, type XcapJsonResult } from '../api.ts';
...
export type InsertionType = $Values<typeof Insertion>;
...
export type GetCategoryResult = XcapJsonResult & {
	category: ?Category,
...
export type GetByReferenceIdResult = XcapJsonResult & {
...
export type ListCategoriesResult = XcapJsonResult & {
 ...
 */
export function remove({ context, id }: { context: string, id: number }): Thunk<*> {
	return post({
		url: '/category/remove',
		parameters: arguments,
		context,
