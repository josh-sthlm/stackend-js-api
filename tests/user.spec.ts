...
describe('User', () => {
  ...
  describe("hasElevatedPrivilege", () => {
    it('Checks for elevated privileges', async () => {
      ...
      const u = {
        privileges: [
          'cms,se.josh.xcap.cms.CmsManager,32',
          'news,net.josh.community.blog.BlogManager,16'
        ]
      }

      expect(hasElevatedPrivilege(u as any, "cms", "se.josh.xcap.cms.CmsManager", PrivilegeTypeId.TRUSTED)).toBeTruthy();
      expect(hasElevatedPrivilege(u as any, "cms", "se.josh.xcap.cms.CmsManager", PrivilegeTypeId.ADMIN)).toBeTruthy();
      expect(hasElevatedPrivilege(u as any, "cms", "se.josh.xcap.cms.CmsManager", PrivilegeTypeId.SUPER_ADMIN)).toBeFalsy();
